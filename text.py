...
class TextEditor:
  def __init__(self,root):
    ...
    self.status.set("Welcome To My Text Editor")
    self.menubar = Menu(self.root,font=("times new roman",15,"bold"),activebackground="black")
    self.root.config(menu=self.menubar)

    self.filemenu = Menu(self.menubar,font=("times new roman",12,"bold"),activebackground="black",tearoff=0)
    self.filemenu.add_command(label="New File",accelerator="Ctrl+N",command=self.newfile)
    self.filemenu.add_command(label="Open File",accelerator="Ctrl+O",command=self.openfile)
    ...
    self.editmenu = Menu(self.menubar,font=("times new roman",12,"bold"),activebackground="black",tearoff=0)
    ...
    self.helpmenu = Menu(self.menubar,font=("times new roman",12,"bold"),activebackground="black",tearoff=0)
